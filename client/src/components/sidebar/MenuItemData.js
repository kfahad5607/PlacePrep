...
export const admin = [
    ...
    { name: 'My Profile', to: '/me', icon: 'fa fa-user-circle', subMenuItems: [] },
    { name: 'Users', to: '/users', icon: 'fa fa-user', subMenuItems: [] },
    { name: 'Coding Questions', to: '/codeQuestions', icon: 'fa fa-code', subMenuItems: [] },
    { name: 'See all quizzes', to: '/quizzes', icon: 'fa fa-question', subMenuItems: [] },
...
export const student = [
    ...
    { name: 'My Profile', to: '/me', icon: 'fa fa-user-circle', subMenuItems: [] },
    { name: 'Coding Questions', to: '/codeQuestions', icon: 'fa fa-code', subMenuItems: [] },
    { name: 'Code Submissions', to: '/codeSubmissions', icon: 'fa fa-tasks', subMenuItems: [] },
    { name: 'See all quizzes', to: '/quizzes', icon: 'fa fa-question', subMenuItems: [] },
    { name: 'Quiz Submissions', to: '/quizSubmissions', icon: 'fa fa-tasks', subMenuItems: [] },
    { name: 'Practice Problems', to: '/practiceProblems', icon: 'fa fa-pie-chart', subMenuItems: [] },
];
